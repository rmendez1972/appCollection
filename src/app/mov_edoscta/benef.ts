export class Benef {
  ...
  constructor(public mid_beneficiario:number, public mid_catprog: number,public mclave_elect:String, public mcurp:String,
      public mrfc: String, public mnombre: String ){
