...
export class Mov_diversos {
	...
	constructor (
		...
		public mfecha_div:Date, 				public mpoliza:String, 				public mrecibo:number, 
		...
		public mpoliza_apli:String,			public mfecha_apli:Date, 			public minteres:number, 
